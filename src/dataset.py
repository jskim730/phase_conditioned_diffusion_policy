"""Dataset and normalization utilities for Phase-Conditioned Diffusion Policy.

This module is shared by the data-pipeline notebook and all downstream
training/evaluation notebooks.  It owns sample indexing, obs/action
normalization helpers, artifact loading, and DataLoader construction.
"""
